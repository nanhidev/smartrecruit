...
"Email ID field is not empty", loginPage.isEmailFieldEmpty();
}
...
"Dashboard is not displayed after delay", loginPage.isDashboardDisplayedAfterDelay();
}
...
"User is not redirected to the login screen", loginPage.isOnLoginScreen();
}
